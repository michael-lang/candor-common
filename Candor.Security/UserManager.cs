...
namespace Candor.Security
{
	...
	*/
	public static class UserManager
	{
		...
		private static prov.ProviderCollection<UserProvider> _providers;
		private static ILog _logProvider = null;
		#endregion
		...
		public static ILog LogProvider
		{
			get
			{
				if (_logProvider == null)
					_logProvider = LogManager.GetLogger(typeof(UserManager));
				return _logProvider;
			}
		...
		public static prov.ProviderCollection<UserProvider> Providers
		{
			...
			{
				if (_providers == null)
					_providers = new prov.ProviderCollection<UserProvider>(typeof(UserManager));
				return _providers;
			}
		}
