...
namespace Candor
{
    ...
    public class LexicalIncrementAsciiAlphaNumericTests
    {
        ...
        {
            var s = "1234";
            var s2 = s.LexicalIncrement(LexicalCharacterSetType.AsciiAlphaNumeric.ToCharacterSet(), true);
        ...
        {
            var s = "1234";
            var s2 = s.LexicalIncrement(LexicalCharacterSetType.AsciiAlphaNumeric.ToCharacterSet(), false);
